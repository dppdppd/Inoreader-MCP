...
class OAuth2Handler:
    ...
    def __init__(self, client_id: str, client_secret: str):
        ...
        Args:
            client_id: OAuth2 client ID from Inoreader app registration
            client_secret: OAuth2 client secret from Inoreader app registration
        """
    ...
    def get_authorization_url(self, state: str, redirect_uri: str = 'http://localhost:8080/callback') -> str:
        """
    ...
    async def exchange_code_for_tokens(self, code: str, redirect_uri: str = 'http://localhost:8080/callback') -> Dict:
        """
